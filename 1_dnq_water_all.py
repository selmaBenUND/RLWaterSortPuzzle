...
tempdir = "/home/tala/workplace/results"
tempdir = os.path.join(tempdir, 'water-newdeep-masked-reward-fixed-all')
...
initial_state_reuse_list=[0.0,0.1,0.2,0.5,0.9,1]
reward_type_list=[0,1,2,3] #4 valid/invalid
max_number_initial_state_reuse_list=[10,50,500,1000]

num_iterations_default = 100000#20000#1000#2000 
...
def param_prep(i, reward_type, intern_param, index_param, parameter):
...
for parameter in num_iterations_list:
    for reward_type in reward_type_list:
            params = param_prep(i, reward_type, intern_param, index_param, parameter)
            print(params)
            wsp_dqn_learning(params)
            i+=1

index_param=2
for parameter in learning_rate_list:
    for reward_type in reward_type_list:
            params = param_prep(i, reward_type, intern_param, index_param, parameter)
            wsp_dqn_learning(params)
...
index_param=3
for parameter in num_eval_episodes_list:
    for reward_type in reward_type_list:
            params = param_prep(i, reward_type, intern_param, index_param, parameter)
            wsp_dqn_learning(params)
...
index_param=4
for parameter in collect_steps_per_iteration_list:
    for reward_type in reward_type_list:
            params = param_prep(i, reward_type, intern_param, index_param, parameter)
            wsp_dqn_learning(params)
...
index_param=5
for parameter in eval_interval_list:
    for reward_type in reward_type_list:
            params = param_prep(i, reward_type, intern_param, index_param, parameter)
            wsp_dqn_learning(params)
...
index_param=6
for parameter in replay_buffer_max_length_list:
    for reward_type in reward_type_list:
            params = param_prep(i, reward_type, intern_param, index_param, parameter)
            wsp_dqn_learning(params)
...
index_param=7
for parameter in batch_size_list:
    for reward_type in reward_type_list:
            params = param_prep(i, reward_type, intern_param, index_param, parameter)
            wsp_dqn_learning(params)
...
index_param=1
for parameter in initial_state_reuse_list:
    for reward_type in reward_type_list:
            params = param_prep(i, reward_type, intern_param, index_param, parameter)
            wsp_dqn_learning(params)
...
index_param=3                                
for parameter in max_number_initial_state_reuse_list:
    for reward_type in reward_type_list:
            params = param_prep(i, reward_type, intern_param, index_param, parameter)
            wsp_dqn_learning(params)
