...
class MaskedRandomTFPolicy(random_tf_policy.RandomTFPolicy):
  ...
  def __init__(self, time_step_spec: ts.TimeStep,
    ...
    super().__init__(time_step_spec, action_spec, *args,
                                         **kwargs)

    #super(MaskedRandomTFPolicy, self).__init__(time_step_spec, action_spec, *args,**kwargs)
  ...
  def _action(self, time_step, policy_state, seed):
    ...
    if observation_and_action_constraint_splitter is not None:
      ...
      #action_ = tf.cast(masked_categorical.sample() + action_spec.minimum,action_spec.dtype)
      action_ = tf.reshape(tf.cast(masked_categorical.sample() + self.action_spec.minimum,
