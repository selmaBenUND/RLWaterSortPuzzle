...
tempdir = os.path.join(tempdir, 'water-newdeep-masked-reward-ddqn-actions')
...
def wsp_dqn_learning(params):
        ...
        agent = cpu.DDQN(train_env,q_net,optimizer,loss_function,train_step_counter,env_values[0],cpu.observation_action_splitter)
        agent.initialize()
...
num_iterations_default = 1000000#20000#1000#2000 
